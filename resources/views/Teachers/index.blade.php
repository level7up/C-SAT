...
@section('content')
                    ...
                    <div class="form-group">
                        ...
                        <div style="padding-left:20px" >
                            ...
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="Title" value="T.A" required autofocus>
                                <span class="form-check-sign"></span>T.A</label>
                            </div>
    ...
    <script type="text/javascript">
        ...
        var lastIndex = 0;
        // Get Data
        firebase.database().ref('com/ta/').on('value', function(snapshot) {
            ...
            $.each(value, function(index, value){
                if(value) {
                    htmls.push('<tr>\
                        ...
                        <td><a href="/ta/'+ value.id +'" >'+ value.fullname +'</a></td>\
                        <td>'+ value.Title +'</td>\
                        <td>'+ value.Email +'</td>\
        ...
        $('#submitUser').on('click', function(){
            ...
            firebase.database().ref('com/ta/' + userID).set({
                fullname: fullname,
                Email: Email,
...
$('body').on('click', '.updateData', function() {
	...
	firebase.database().ref('com/ta/' + updateID).on('value', function(snapshot) {
...
$('.updateUserRecord').on('click', function() {
	...
	var updates = {};
	updates['/com/ta/' + updateID] = postData;
...
$('.deleteMatchRecord').on('click', function(){
	...
	firebase.database().ref('com/ta/' + id).remove();
